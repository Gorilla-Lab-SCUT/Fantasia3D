...
- (2023.10.13)
  - Add a FAQ about the problem of oversaturion appearance, i.e. Q7.
- (2023.09.01)
...
***Q7***: *Can Fantasia3D generate photorealistic appearance without oversaturation?*

Answer: Yes, it can. Just Original SDS loss combined with negative prompt and strategy 2 proposed in Fantasia3D is enough to address the oversaturated problem. The appearance of the DMTet-based gallery in [Sweetdreamer](https://sweetdreamer3d.github.io/dmtet-based-gallery_0.html) is generated by the code of appearance modeling in Fantasia3D. You can see that all the results are highly detailed and do have not the problem of oversaturation. I think the key is the disentangled representation and the adoption of the negative prompt and strategy 2.
